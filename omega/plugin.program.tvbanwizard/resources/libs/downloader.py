        ...
        with open(dest, 'wb') as f:
            ...
            if total is None:
                ...
                for chunk in response.iter_content(chunk_size=max(int(total/512), mb)):
                    ...
                    currently_downloaded = '[COLOR azure][B]Descargando: [COLOR yellowgreen]TVban matnexom_amillans [COLOR khaki]... [COLOR azure] - Espere por Favor.[/B][/COLOR]'.format(CONFIG.ADDONTITLE)  + '\n' + '[COLOR %s][B]Tamaño:[/B] [COLOR %s]%.02f[/COLOR] [COLOR tan]MB[/COLOR] de [COLOR %s]%.02f[/COLOR] [COLOR tan]MB[/COLOR]' % (CONFIG.COLOR2, CONFIG.COLOR1, downloaded / mb, CONFIG.COLOR1, total / mb)
