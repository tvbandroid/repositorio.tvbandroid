...
def findvideos(data, skip=False, disabled_servers=False):
    ...
    for serverid in servers_list:
        ...
        if skip and len(devuelve) >= _skip:
            devuelve = devuelve[:_skip]
            break
...
def get_server_id(serverid):
    # ~ Manual para evitar recorrer todos los servidores !? (buscar "more_ids" en los json de servidores)
...
def corregir_servidor(servidor):
    ...
    elif servidor in ['doodstream', 'dood', 'dooood', 'ds2play', 'doods', 'ds2video', 'd0o0d', 'do0od', 'd0000d', 'd000d', 'dooodster', 'vidply', 'all3do', 'do7go', 'doodcdn', 'doply', 'vide0', 'vvide0', 'd-s', 'dsvplay', 'myvidplay', 'playmogo']: return 'doodstream'
...
def corregir_other(srv):
    ...
    elif 'dropload' in srv or 'dr0pstream' in srv: srv = 'Dropload'
    ...
    elif 'filemoon' in srv or 'fmoonembed' in srv or 'embedmoon' in srv or 'moonjscdn' in srv or 'l1afav' in srv or 'byseqekaho' in srv or 'bysedikamoum' in srv or 'bysevepoin' in srv or 'byseraguci' in srv or 'bysewihe' in srv or 'bysejikuar' in srv or 'bysesukior' in srv or 'byselapuix' in srv or 'bysezoxexe' in srv or 'embedplaybyse' in srv or 'bysekoze' in srv or 'byse' in srv: srv = 'Filemoon'
    ...
    elif 'lulustream' in srv or 'luluvdo' in srv or 'luluvid' in srv or 'streamhihi' in srv or 'lulustream' in srv or 'luluvdoo' in srv or 'lulu' in srv or 'ponmi' in srv or 'd00ds.site' in srv: srv = 'Lulustream'

    elif 'turboviplay' in srv or 'emturbovid' in srv or 'tuborstb' in srv or 'stbturbo' in srv or 'turbovidhls' in srv: srv = 'Turboviplay'
    ...
    elif 'vidhide' in srv or 'stblion' in srv or 'dhtpre' in srv or 'dramacool' in srv or 'morencius' in srv: srv = 'Vidhidepro'
    ...
    elif 'abyss' in srv or 'allviid' in srv or 'cloudfile' in srv or 'cloudmail' in srv or 'dailyuploads' in srv or 'darkibox' in srv or 'dembed' in srv or 'downace' in srv or 'fastdrive' in srv or 'fastplay' in srv or 'filegram' in srv or 'gostream' in srv or 'letsupload' in srv or 'liivideo' in srv or 'myupload' in srv or 'neohd' in srv or 'oneupload' in srv or 'pandafiles' in srv or 'rovideo' in srv or 'send' in srv or 'streamable' in srv or 'streamdav' in srv or 'streamgzzz' in srv or 'streamoupload' in srv or 'turbovid' in srv or 'tusfiles' in srv or 'uploadba' in srv or 'uploadflix' in srv or 'uploadhub' in srv or 'uploady' in srv or 'upvid' in srv or 'veev' in srv or 'doods' in srv or 'veoh' in srv or 'vidbob' in srv or 'vidlook' in srv or 'vidmx' in srv or 'vidnest' in srv or 'vid' in srv or 'vidpro' in srv or 'vipss' in srv or 'vkprime' in srv or 'worlduploads' in srv or 'ztreamhub' in srv or 'amdahost' in srv or 'updown' in srv or 'videa' in srv or 'asianplay' in srv or 'swiftload' in srv or 'udrop' in srv or 'vidtube' in srv or 'bigwarp' in srv or 'bgwp' in srv or 'wecima' in srv or 'asianload' in srv or 'savefiles' in srv or 'streamhls' in srv or 'vidbasic' in srv or 'vidb' in srv or 'vimeos' in srv or 'bigshare' in srv or 'streamix' in srv or 'stmix' in srv or 'vidara' in srv or 'vidsonic' in srv or 'vixeo' in srv or 'bowfile' in srv or 'gupload' in srv: srv = 'Zures'
...
def corregir_zures(srv):
    ...
    if 'abyss' in srv: srv = 'abyss'
    elif 'allviid' in srv: srv = 'allviid'
    ...
    elif 'bigshare' in srv: srv = 'bigshare'
    elif 'streamix' in srv or 'stmix' in srv: srv = 'streamix'
    elif 'vidara' in srv: srv = 'vidara'
    elif 'vidsonic' in srv or 'vixeo' in srv: srv = 'vidsonic'
