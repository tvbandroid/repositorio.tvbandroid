...
def sync_settings(params={}):
	...
	if 'load_properties' in params:
		...
		# AM Lite y el servicio de arranque solo actualizan settings.db; la recarga completa de propiedades es para RECREAR LA CACHÉ DE CONFIGURACIÓN.
...
def set_default(setting_ids):
	...
	if not kodi_utils.confirm_dialog(text='Está Seguro??', ok_label='Sí', cancel_label='No', default_control=11): return
...
def set_string(params):
	...
	if setting_id == 'tmdb_api' and new_value and looks_like_tmdb_v4_jwt(new_value):
		kodi_utils.ok_dialog(
			...
			text='Este Es Un Token De Acceso De Lectura TMDb V4 (JWT), No La Clave API V3.[CR]Utilice TMDb Lists → Token De Acceso De Lectura Para Los Tokens V4.'
		)
		return set_string(params)
...
def set_numeric(params):
	...
	if int(new_value) < min_value or int(new_value) > max_value:
		kodi_utils.ok_dialog(text='Seleccione Un Valor Entre [B]%s - %s[/B].' % (min_value, max_value))
...
{'setting_id': 'media_open_action_movie', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Ninguna', '1': 'Abrir Extras', '2': 'Abrir Colección', '3': 'Ambas'}},

{'setting_id': 'media_open_action_tvshow', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Ninguna', '1': 'Abrir Extras'}},
...
#==================== General
{'setting_id': 'paginate.lists', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Desactivado', '1': 'Solo En El Addon', '2': 'Solo En Widgets', '3': 'Ambos'}},
...
{'setting_id': 'recommend_service', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Recomendado (TMDb)', '1': 'Más Como Esto (IMDb)', '2': 'Similar (IA)', '3': 'Relacionado (Trakt)'}},

{'setting_id': 'recommend_seed', 'setting_type': 'action', 'setting_default': '5',
'settings_options': {
'1': 'Solo El Último Visto',
'2': 'Últimos 2 Vistos',
'3': 'Últimos 3 Vistos',
'4': 'Últimos 4 Vistos',
'5': 'Últimos 5 Vistos',
...
{'setting_id': 'tv_progress_location', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Vistos', '1': 'En Progreso', '2': 'Ambos'}},
...
{'setting_id': 'default_all_episodes', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Nunca', '1': 'Si Solo Hay Una Temporada', '2': 'Siempre'}},
...
#==================== Orden De Contenido Para Progreso De Visualización
{'setting_id': 'sort.progress', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Título', '1': 'Vistos Recientemente'}},

{'setting_id': 'sort.watched', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Título', '1': 'Vistos Recientemente'}},

#==================== Orden De Contenido Para Listas Simkl
{'setting_id': 'sort.simkl', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {
'0': 'Título',
'1': 'Fecha De Adición (Desc)',
'2': 'Fecha De Estreno (Desc)',
'3': 'Fecha De Adición (Asc)',
'4': 'Fecha De Estreno (Asc)'}},

#==================== Orden De Contenido Para Listas Trakt
{'setting_id': 'sort.collection', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {
'0': 'Título',
'1': 'Fecha De Adición (Desc)',
'2': 'Fecha De Estreno (Desc)',
...
{'setting_id': 'sort.watchlist', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {
'0': 'Título',
'1': 'Fecha De Adición (Desc)',
'2': 'Fecha De Estreno (Desc)',
...
#==================== Orden De Contenido Para Listas TMDb
{'setting_id': 'tmdbsort.watchlist', 'setting_type': 'action', 'setting_default': '4',
'settings_options': {
'0': 'Título',
'1': 'Fecha De Estreno (Asc)',
'2': 'Fecha De Estreno (Desc)',
'3': 'Aleatorio',
'4': 'Predeterminado De TMDb (Ninguno)'}},

{'setting_id': 'tmdbsort.favorites', 'setting_type': 'action', 'setting_default': '4',
'settings_options': {
'0': 'Título',
'1': 'Fecha De Estreno (Asc)',
'2': 'Fecha De Estreno (Desc)',
...
#==================== Pósteres Con Valoraciones RPDb
{'setting_id': 'rpdb_enabled', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Ninguno', '1': 'Películas', '2': 'Series', '3': 'Ambos'}},

{'setting_id': 'rpdb_format', 'setting_type': 'string', 'setting_default': ''},

#==================== Menú Contextual
{'setting_id': 'context_menu.enabled', 'setting_type': 'string',
'setting_default': 'extras,options,playback_options,browse_movie_set,browse_seasons,browse_episodes,recommended,related,more_like_this,similar,in_trakt_list,mdblist_manager,simkl_manager,trakt_manager,tmdb_manager,personal_manager,favorites_manager,mark_watched,unmark_previous_episode,exit,refresh,reload'},
...
'settings_options': {'0': 'TÍTULO: TxE - EPISODIO', '1': 'TxE - EPISODIO', '2': 'EPISODIO'}},
...
#==================== Próximos Episodios
{'setting_id': 'nextep.method', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Último Emitido', '1': 'Último Visto'}},

{'setting_id': 'nextep.sort_type', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Vistos Recientemente', '1': 'Fecha De Emisión', '2': 'Título'}},

{'setting_id': 'nextep.sort_order', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Descendente', '1': 'Ascendente'}},
...
{'setting_id': 'nextep.include_unwatched', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Ninguno', '1': 'Lista De Seguimiento', '2': 'Favoritos', '3': 'Ambos'}},
...
{'setting_id': 'trakt.calendar_sort_order', 'setting_type': 'action', 'setting_default': '0',
'settings_options': {'0': 'Descendente', '1': 'Ascendente'}},
...
{'setting_id': 'results.size_sort_direction', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'Descendiendo', '1': 'Ascendiendo'}},
...
#==================== Colores Destacados de Resultados
