...
class Navigator:
	...
	def tools(self):
		...
		if get_setting('playtvban.external_scraper.module') not in ('empty_setting', ''):
		...
		self.add({'mode': 'language_invoker_choice', 'isFolder': 'false'}, 'Alternar Invocador de Lenguaje (¡¡AVANZADO!!)', 'settings2')
		self.end_directory()
