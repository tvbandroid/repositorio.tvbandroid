...
def list_display_choices(list_type):
	return {
'tmdb': {'choices': [('Título', '0'), ('Fecha de Creación (asc)', '1'), ('Fecha de Creación (desc)', '2'), ('Actualizado Recientemente (asc)', '3'), ('Actualizado Recientemente (desc)', '4'),
('Cantidad de Elementos (asc)', '5'), ('Cantidad de Elementos (desc)', '6'), ('Valoración Media (asc)', '7'), ('Valoración Media (desc)', '8'), ('Duración Total (asc)', '9'),
('Duración Total (desc)', '10'), ('Ingresos Totales (asc)', '11'), ('Ingresos Totales (desc)', '12')],
'setting': 'tmdblist'},
'personal': {'choices': [('Título', '0'), ('Autor', '1'), ('Fecha de Creación (asc)', '2'), ('Fecha de Creación (desc)', '3'),
('Actualizado Recientemente (asc)', '4'), ('Actualizado Recientemente (desc)', '5'), ('Cantidad de Elementos (asc)', '6'), ('Cantidad de Elementos (desc)', '7')],
