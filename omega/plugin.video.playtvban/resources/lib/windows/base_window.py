				        ...
				        <control type="panel" id="{container_no}">
				            ...
				            <itemlayout height="380" width="590">
				                <control type="image">
				                    <height>360</height>
				                    <width>580</width>
				                    <texture colordiffuse="$INFO[Window(10000).Property(playtvban.window_theme.extras)]" border="30">redlight_common/circle.png</texture>
				                </control>
                ...
                <control type="group">
                    ...
                    <control type="group">
                        ...
                        <control type="button" id="{container_no}">
                            ...
                            <texturenofocus colordiffuse="$INFO[Window(10000).Property(playtvban.window_theme.extras)]" border="30">redlight_common/circle.png</texturenofocus>
                        </control>
                        <control type="textbox">
                            <top>65</top>
                            <left>15</left>
                ...
                <control type="group">
                    ...
                    <control type="group">
                        ...
                        <control type="button" id="15">
                            ...
                            <focusedcolor>FF1F2020</focusedcolor>
                            <texturefocus colordiffuse="FFCCCCCC" border="30">redlight_common/circle.png</texturefocus>
                            <texturenofocus colordiffuse="$INFO[Window(10000).Property(playtvban.window_theme.extras)]" border="30">redlight_common/circle.png</texturenofocus>                         <align>center</align>
                            <aligny>center</aligny>
                        </control>
