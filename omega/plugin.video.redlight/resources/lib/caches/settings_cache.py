...
{'setting_id': 'sort.simkl', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'Título', '1': 'Añadidos Recientemente (desc)', '2': 'Estrenos Recientes (desc)', '3': 'Añadidos Más Antiguos (asc)', '4': 'Estrenos Más Antiguos (asc)'}},
#==================== Contents Sort Order For Trakt Lists
{'setting_id': 'sort.collection', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'Título', '1': 'Añadidos Recientemente (desc)', '2': 'Estrenos Recientes (desc)', '3': 'Añadidos Más Antiguos (asc)', '4': 'Estrenos Más Antiguos (asc)'}},
{'setting_id': 'sort.watchlist', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'Título', '1': 'Añadidos Recientemente (desc)', '2': 'Estrenos Recientes (desc)', '3': 'Añadidos Más Antiguos (asc)', '4': 'Estrenos Más Antiguos (asc)'}},
#==================== Contents Sort Order For TMDb Lists
{'setting_id': 'tmdbsort.watchlist', 'setting_type': 'action', 'setting_default': '4', 'settings_options': {'0': 'Título', '1': 'Añadidos Recientemente (asc)', '2': 'Estrenos Recientes (desc)',
'3': 'Aleatorio', '4': 'Predeterminado de TMDb (Ninguno)'}},
{'setting_id': 'tmdbsort.favorites', 'setting_type': 'action', 'setting_default': '4', 'settings_options': {'0': 'Título', '1': 'Añadidos Recientemente (asc)', '2': 'Estrenos Recientes (desc)',
'3': 'Aleatorio', '4': 'Predeterminado de TMDb (Ninguno)'}},
#==================== Personal Lists
