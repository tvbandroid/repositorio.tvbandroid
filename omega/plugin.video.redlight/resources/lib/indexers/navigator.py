...
class Navigator:
	...
	def discover(self):
		...
		self.add({'mode': 'navigator.discover_contents', 'media_type': 'tvshow'}, 'Series de TV', 'tv')
		self.end_directory()
	...
	def tools(self):
		...
		if get_setting('redlight.external_scraper.module') not in ('empty_setting', ''):
			self.add({'mode': 'open_external_scraper_settings', 'isFolder': 'false'}, 'Configuración del Raspador Externo', 'settings')
		...
		self.add({'mode': 'navigator.changelog_utils'}, 'Registro de cambios y utilidades', 'settings2')
		self.add({'mode': 'build_next_episode_manager'}, 'Gestor de progreso de series', 'settings2')
		self.add({'mode': 'navigator.shortcut_folders'}, 'Gestor de accesos directos', 'settings2')
		...
		self.add({'mode': 'language_invoker_choice', 'isFolder': 'false'}, 'Invocador de Cambio de Idioma (¡AVANZADO!)', 'settings2')
		self.end_directory()

	def import_export(self):
		self.add({'mode': 'local_backup.import_data', 'isFolder': 'false'}, 'Importar Favoritos y Progreso de Red Light', 'settings')
		self.add({'mode': 'local_backup.export_data', 'isFolder': 'false'}, 'Exportar Favoritos y Progreso de Red Light', 'settings')
		self.end_directory()
	...
	def maintenance(self):
		...
		self.add({'mode': 'sync_settings', 'silent': 'false', 'isFolder': 'false'}, 'Reconstruir Cache de Configuración', 'settings')
		self.add({'mode': 'clear_all_cache', 'isFolder': 'false'}, 'Borrar Toda la Cache (Excepto Favoritos)', 'settings')
		self.add({'mode': 'clear_favorites_choice', 'isFolder': 'false'}, 'Borrar Cache de Favoritos', 'settings')
		self.add({'mode': 'search.clear_search', 'isFolder': 'false'}, 'Borrar Cache del Historial de Búsquedas', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'main', 'isFolder': 'false'}, 'Borrar Cache Principal', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'meta', 'isFolder': 'false'}, 'Borrar Cache de Metadatos', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'list', 'isFolder': 'false'}, 'Borrar Cache de Listas', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'ai_functions', 'isFolder': 'false'}, 'Borrar Cache de Datos de IA', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'tmdb_list', 'isFolder': 'false'}, 'Borrar Cache de Listas Personales de TMDb', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'trakt', 'isFolder': 'false'}, 'Borrar Cache de Trakt', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'imdb', 'isFolder': 'false'}, 'Borrar Cache de IMDb', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'internal_scrapers', 'isFolder': 'false'}, 'Borrar Cache de Scrapers Internos', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'easynews_scrape', 'isFolder': 'false'}, 'Borrar Cache de Búsquedas de EasyNews', 'settings')
		self.add({'mode': 'search.clear_easynews_search_history', 'isFolder': 'false'}, 'Borrar Historial de Búsquedas de EasyNews', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'external_scrapers', 'isFolder': 'false'}, 'Borrar Caché de Búsquedas Externas', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'rd_cloud', 'isFolder': 'false'}, 'Borrar Cache de Real-Debrid', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'pm_cloud', 'isFolder': 'false'}, 'Borrar Cache de Premiumize', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'ad_cloud', 'isFolder': 'false'}, 'Borrar Cache de AllDebrid', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'oc_cloud', 'isFolder': 'false'}, 'Borrar Cache de Offcloud', 'settings')
		self.add({'mode': 'clear_cache', 'cache': 'tb_cloud', 'isFolder': 'false'}, 'Borrar Cache de TorBox', 'settings')
		self.end_directory()

	def set_view_modes(self):
		self.add({'mode': 'navigator.choose_view', 'view_type': 'view.main', 'content': '', 'name': 'menus'}, 'Configurar Vistas de Menus', 'folder')
		self.add({'mode': 'navigator.choose_view', 'view_type': 'view.movies', 'content': 'movies'}, 'Configurar Vista de Películas', 'movies')
		self.add({'mode': 'navigator.choose_view', 'view_type': 'view.tvshows', 'content': 'tvshows'}, 'Configurar Vista de Series', 'tv')
		self.add({'mode': 'navigator.choose_view', 'view_type': 'view.seasons', 'content': 'seasons'}, 'Configurar Vista de Temporadas', 'ontheair')
		self.add({'mode': 'navigator.choose_view', 'view_type': 'view.episodes', 'content': 'episodes'}, 'Configurar Vista de Episodios', 'next_episodes')
		self.add({'mode': 'navigator.choose_view', 'view_type': 'view.episodes_single', 'content': 'episodes', 'name': 'episode lists'}, 'Configurar Vista de Listas de Episodios', 'calender')
		self.add({'mode': 'navigator.choose_view', 'view_type': 'view.premium', 'content': 'files', 'name': 'premium files'}, 'Configurar Vista de Archivos Premium', 'premium')
		self.end_directory()
	...
	def choose_view(self):
		...
		self.add({'mode': 'navigator.set_view', 'view_type': view_type, 'name': name, 'isFolder': 'false'}, 'Seleccione la vista y luego pulse aquí', 'settings')
