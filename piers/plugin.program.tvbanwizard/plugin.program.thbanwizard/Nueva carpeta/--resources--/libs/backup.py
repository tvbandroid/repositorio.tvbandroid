...
def cleanup_backup():
    ...
    selected = dialog.select("{0}\n\Seleccione los elementos que desee \n\eliminar de la carpeta [COLOR moccasin]'Mis_Build'[/COLOR].".format(CONFIG.ADDONTITLE),
                             list)
    ...
    if selected == -1:
        ...
        if dialog.yesno(CONFIG.ADDONTITLE, "[COLOR {0}]Le gustaría limpiar todos los elementos en su carpeta 'Mis_Build'?[/COLOR]".format(CONFIG.COLOR2) + '\n' + "[COLOR {0}]{1}[/COLOR]".format(CONFIG.COLOR1, CONFIG.MYBUILDS),
        ...
        if dialog.yesno(CONFIG.ADDONTITLE, "[COLOR {0}]Le gustaria eliminar[COLOR {1}]{2}[/COLOR] de la carpeta 'Mis_Build'?[/COLOR]".format(CONFIG.COLOR2, CONFIG.COLOR1, list[selected]) + '\n' + "[COLOR {0}]{1}[/COLOR]".format(CONFIG.COLOR1, path),
                        yeslabel="[B][COLOR cyan]Limpiar[/COLOR][/B]",
                        nolabel="[B][COLOR red]No, Cancelar[/COLOR][/B]"):
