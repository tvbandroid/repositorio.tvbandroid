...
def upload_log():
    ...
    for item in files:
        ...
        if succes:
            ...
            if succes:
                msg = "[COLOR gold]Post this url or scan QRcode for your[/COLOR] [COLOR {0}]{1}[/COLOR][COLOR gold],[/COLOR]" \
                      "[COLOR gold]together with a description of the problem:[/COLOR][CR][COLOR {2}]{3}[/COLOR]".format(
