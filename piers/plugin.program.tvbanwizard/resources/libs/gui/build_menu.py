...
class BuildMenu:
    ...
    def get_listing(self):
        ...
        if response:
            ...
            directory.add_dir('[COLOR gold]Save Data Menu[/COLOR]', {'mode': 'savedata'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME3)
        ...
        directory.add_file('[COLOR gold]Kodi Version:[/COLOR] {0}'.format(CONFIG.KODIV), icon=CONFIG.ICONBUILDS, themeit=CONFIG.THEME3)
        directory.add_dir('[COLOR gold]Save Data Menu[/COLOR]', {'mode': 'savedata'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME3)
        directory.add_separator()
        ...
        if len(match) >= 1:
            ...
            if adultcount > 0:
                directory.add_file('There are currently only Adult builds', icon=CONFIG.ICONBUILDS,
                                   themeit=CONFIG.THEME3)
                directory.add_file('Enable Show Adults in Add-on Settings > Misc', icon=CONFIG.ICONBUILDS,
                                   themeit=CONFIG.THEME3)
            else:
    ...
    def view_build(self, name):
        ...
        for version, url, gui, kodi, themefile, icon, fanart, preview, adult, info, description in match:
            ...
            directory.add_separator()
            directory.add_dir('[COLOR gold]Save Data Menu[/COLOR]', {'mode': 'savedata'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME3)
            directory.add_file('[COLOR gold]Build Information[/COLOR]', {'mode': 'buildinfo', 'name': name}, description=description, fanart=fanart,
            ...
            if versioncheck:
                directory.add_file(
                    '[I]Build designed for Kodi v{0} [COLOR gold](installed: v{1})[/COLOR][/I]'.format(str(kodi), str(CONFIG.KODIV)),
