...
class MaintenanceMenu:
    ...
    def logging_menu(self):
        ...
        if errors > 0:
            directory.add_file('[COLOR khaki]Ver el Ultimo Error en el Log[/COLOR]', {'mode': 'viewerrorlast'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        directory.add_file('[COLOR khaki]Ver Archivo de Registro[/COLOR]', {'mode': 'viewlog'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        directory.add_file('[COLOR khaki]Ver Archivo de Registro del Wizard[/COLOR]', {'mode': 'viewwizlog'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
