...
addonname = '[COLOR yellow]fenix-mac [COLOR white]XC MAC M3U[/COLOR]'
icon = addon.getAddonInfo('icon')
myaddon = xbmcaddon.Addon("plugin.video.fenix-mac")
#px={"http": "http://14.139.189.213:3128"}
px=''
local_file=translatePath('special://home/addons/plugin.video.fenix-mac/proxy.dat')

## Fotos
thmb_nada='https://i.imgur.com/SCc34X2.png'
thmb_ver_canales='https://i.imgur.com/bMM5liD.jpg'
thmb_ver_canais='https://i.imgur.com/bMM5liD.jpg'
thmb_muda_servidor='https://i.imgur.com/fXEPxHM.jpg'
thmb_muda_mac='https://i.imgur.com/moE50OY.jpg'
thmb_cambio_mac='https://i.imgur.com/moE50OY.jpg'
thmb_cambio_servidor='https://i.imgur.com/fXEPxHM.jpg'
thmb_carrega_servidores='https://i.imgur.com/fXEPxHM.jpg'
thmb_guarda_servidores='https://i.imgur.com/KAeNkfI.jpg'
thmb_novo_servidor='https://i.imgur.com/KAeNkfI.jpg'
thmb_guia='https://i.imgur.com/SCc34X2.png'
backgr="https://i.imgur.com/YzD6GCV.jpg"
fanny="https://i.imgur.com/YzD6GCV.jpg"
fanart_guia="https://i.imgur.com/YzD6GCV.jpg"
thmb_ver_stb='https://i.imgur.com/KAeNkfI.jpg'
thmb_ver_vod='https://i.imgur.com/YzD6GCV.jpg'
...
mislogos = translatePath(os.path.join('special://home/addons/plugin.video.pontenforma/jpg/'))
...
def cambia_fondo():
    ...
    foto = translatePath('special://home/addons/plugin.video.fenix-mac/fondo.jpg')    
...
def main_list(params):
    ...
    params['fanart']="https://i.imgur.com/YzD6GCV.jpg"
...
def macpastebin(params):
    ...
    plugintools.log("fenix.mac.macpastebin")    
    plugintools.add_item(action="ver_canales",    title="LISTA (Baixar) MAC ATIVADA",thumbnail=thmb_ver_canales,fanart="https://i.imgur.com/YzD6GCV.jpg",folder= True )            
    plugintools.add_item(action="", thumbnail=thmb_nada,title="[COLOR yellow]-------------------------------------------[/COLOR][COLOR gray]Configuração atual[/COLOR][COLOR yellow]-------------------------------------------[/COLOR]",folder= False )
    plugintools.add_item(action="cambio_servidor",    title="PORTAL Atual:   "+escogido,thumbnail=thmb_cambio_servidor,fanart="https://i.imgur.com/YzD6GCV.jpg",folder= True )               
    plugintools.add_item(action="cambio_mac",         title="Mudar MAC - MAC Atual:   "+mac,thumbnail=thmb_cambio_mac,fanart="https://i.imgur.com/YzD6GCV.jpg",folder= True )
    plugintools.add_item(action="", thumbnail=thmb_nada,title="[COLOR yellow]-------------------------------------------[/COLOR][COLOR gray]Listas Pessoal[/COLOR][COLOR yellow]-------------------------------------------[/COLOR]",folder= False )
    plugintools.add_item( action="macx", title="Minhas listas Mac", thumbnail = thmb_ver_stb, fanart="https://i.imgur.com/YzD6GCV.jpg",page="",url="",folder=True )
    plugintools.add_item( action="macxadd", title="Escrever listas Mac", thumbnail = thmb_ver_stb, fanart="https://i.imgur.com/YzD6GCV.jpg",page="",url="",folder=True )
    plugintools.add_item(action="", thumbnail=thmb_nada,title="[COLOR yellow]-------------------------------------------[/COLOR][COLOR gray]Grupo Black Eagle[/COLOR] [COLOR yellow]-------------------------------------------[/COLOR]",folder= False )
    #plugintools.add_item( action="settings", title="[COLOR orange]Configuragäo[/COLOR]", thumbnail = thmb_ver_set, fanart= backgr,page="",url="",folder=False )
...
def mac2(params):
    ...
    plugintools.add_item( action="tombola", title="[COLOR orange]Canal livre [/COLOR]", thumbnail = thmb_ver_canais, fanart= backgr,page=mac,url=portal,folder=True )
...
def tombola(params):
    ...
    for generos in data: 
        ...
        ids=patron[0]
        if  ('Portugal' in titulo.lower() or 'Portugal' in titulo.lower() or 'EU- PT' in titulo):               
            color='lime'
        ...
        if  ('adultxxxxxxxxx' in titulo.lower()):                        
             ...
             ret = dialog.select('[COLOR yellow]CONTÉM CANAIS ADULTOS, VOCÊ PRECISA DE UMA SENHA, O QUE VOCÊ QUER?:[/COLOR]', ['[COLOR lime]METER LA CLAVE Y DISFRUTAR DE ELLOS[/COLOR]', '[COLOR aqua]NO QUIERO  LOS CANALES ADULTOS[/COLOR]'])
             lists = ['si', 'no']
             eleccion = lists[ret]
             if 'no' in eleccion:                 
             ...
             if 'si' in eleccion:
                 dialog = xbmcgui.Dialog()
                 d = dialog.input('[B][LOWERCASE][CAPITALIZE][COLOR orange] telegram @black_eagle [/COLOR][/CAPITALIZE][/LOWERCASE][/B]', type=xbmcgui.INPUT_ALPHANUM).replace(" ", "+")
                 if 'x69' in d:
                     ids=ids
                 else:
                     xbmcgui.Dialog().ok('[COLOR orange]A CHAVE ESTA INCORRETA[/COLOR]', '[LOWERCASE][CAPITALIZE][COLOR orange]METE LA CLAVE EN MINUSCULA\nSI NO LO CONSIGUES ESTAMOS EN TELEGRAM [COLOR orange]@TVCHOPO[/COLOR][/CAPITALIZE][/LOWERCASE]')  
...
def lista2(params):
    ...
    pb.create('[COLORcyan]Aguarde[/COLOR],[COLORgrey]os canais estão carregando[/COLOR][COLORcyan]fenix[COLORgrey]Mac[/COLOR] ','')
    count=40;pn=1;data=[]
    while pn <= int(count):
...
def m3u(params):
    ...
    plugintools.add_item( action="edem", title="Edem (ILook)",thumbnail="", fanart="",page="",url= "",folder= True )
    plugintools.add_item( action="listamd", title="[COLOR orange]Lista MD-PT[/COLOR]", thumbnail = thmb_ver_m3u, fanart= backgr,page="",url="",folder=True )
    plugintools.add_item( action="multilistas", title="Liste Portugal",thumbnail="", fanart="",page="",url= "",folder= True )
    plugintools.add_item( action="multilistas_mundo", title="Liste pe tari",thumbnail="", fanart="",page="",url= "",folder=True ) 	
    plugintools.add_item( action="mundotv", title="GitHub IPTV lists", thumbnail = thmb_ver_m3u, fanart= backgr,page="",url="",folder=True )
    plugintools.add_item( action="github", title="GitHub IPTV org", thumbnail = thmb_ver_m3u, fanart= backgr,page="",url="",folder=True )
    plugintools.add_item( action="fluxus", title="Fluxus", thumbnail="", fanart="", page="", url= "", folder=True )    
    plugintools.add_item( action="sphinx", title="Sphinx TV", thumbnail="", fanart="", page="", url= "", folder=True )    
    plugintools.add_item( action="super_iptv", title="Liste XC World",thumbnail="", fanart="",page="",url= "",folder= True )
    plugintools.add_item( action="super_iptv2", title="Liste XC World2",thumbnail="", fanart="",page="",url= "",folder= True )
    #plugintools.add_item( action="tvonline", title="[COLOR orange]TVOnline PT[/COLOR]", thumbnail = thmb_ver_m3u, fanart= backgr,page="",url="",folder=True )
    plugintools.add_item( action="listam3u1", title="[COLOR orange]M3U List 1[/COLOR]", thumbnail = thmb_ver_m3u, fanart= backgr,page="",url="",folder=True )
    

def mundotv(params): 
    plugintools.log("fenix.mac.mundotv")
    thumbnail = params.get("thumbnail")    
    url3 = params.get("url")    
    s = ''
    def macs(s):
...
def multilistas_mundo(params): 
    plugintools.log("fenix.mac.multilistas_mundo")
    thumbnail = params.get("thumbnail")    
...
def edem(params): 
    plugintools.log("fenix.mac.edem")
    thumbnail = params.get("thumbnail")    
    url = params.get("url")
...
def edem2(params): 
    plugintools.log("fenix.mac.edem2")
    thumbnail = params.get("thumbnail")    
...
def multilistas(params): 
    plugintools.log("fenix.mac.adictos ")
    thumbnail = params.get("thumbnail")    
    url = params.get("url")    
    request_headers=[]
    request_headers.append(["User-Agent","Mozilla/5.0 (Windows NT 10.0; rv:75.0) Gecko/20100101 Firefox/75.0"])
    body,response_headers = plugintools.read_body_and_headers( url, headers=request_headers)
    url = body.strip().decode('utf-8')
    url = plugintools.find_single_match(url,'category menu-item-424"><a href="(https://www.gratisiptv.com/.*?roma.*?)">Portugal')    
    request_headers=[]
    request_headers.append(["User-Agent","Mozilla/5.0 (Windows NT 10.0; rv:75.0) Gecko/20100101 Firefox/75.0"])
    body,response_headers = plugintools.read_body_and_headers( url, headers=request_headers)
    url = body.strip().decode('utf-8')
    url = plugintools.find_single_match(url,'(?s)Category: Portugal.*?itemprop="headline"><a href="(.*?)">')
    request_headers=[]
    request_headers.append(["User-Agent","Mozilla/5.0 (Windows NT 10.0; rv:75.0) Gecko/20100101 Firefox/75.0"])
    body,response_headers = plugintools.read_body_and_headers( url, headers=request_headers)
    url = body.strip().decode('utf-8')
    matches = plugintools.find_multiple_matches(url,'((?s)<a href="https://gratisiptv.com/m3u/.*?">Download Portugal IpTV .*?<)')
    for generos in matches:
        matches = plugintools.find_single_match(generos,'(?s)<a href="(https://gratisiptv.com/m3u/.*?)">Download Portugal IpTV (.*?)<')
        url = matches[0]
        titulo = matches[1]
...
def multilistas2(params): 
    plugintools.log("fenix.mac.multilistas2")
    thumbnail = params.get("thumbnail")    
    url3 = params.get("url")
    request_headers=[]
    request_headers.append(["User-Agent","Mozilla/5.0 (Windows NT 10.0; rv:75.0) Gecko/20100101 Firefox/75.0"])
...
def tvonline(params): 
    plugintools.log("fenix.mac.tvonline")
    thumbnail = params.get("thumbnail")    
    url = params.get("url")
...
def tvonline2(params): 
    plugintools.log("fenix.mac.tvonline2")
    thumbnail = params.get("thumbnail") 
...
def listam3u1(params): 
    plugintools.log("fenix.mac.listam3u1")
    thumbnail = params.get("thumbnail")    
...
def listam3u2(params): 
    plugintools.log("fenix.mac.listam3u2")
    thumbnail = params.get("thumbnail")    
...
def fluxus (params):
    thumbnail = params.get("thumbnail")    
    plugintools.log("fenix.mac.fluxus")
...
def fluxus1 (params):
    thumbnail = params.get("thumbnail")    
    plugintools.log("fenix.mac.fluxus1")
...
def sphinx (params):
    thumbnail = params.get("thumbnail")    
    plugintools.log("fenix.mac.sphinx")
...
def sphinxm3u(params): 
    plugintools.log("fenix.mac.sphinxm3u")
    thumbnail = params.get("thumbnail")    
...
def listamd(params): 
    plugintools.log("fenix.mac.listamd")
    thumbnail = params.get("thumbnail")    
...
def ver_canales(params):
    ...
    if source!='':
        ...
        plugintools.add_item( action="pelis", title='[COLOR orange]VOD for server: [ '+escogido+' # '+mac+' ][/COLOR]', thumbnail = thmb_ver_vod, fanart= backgr,page=mac,url=portal,folder=True )
        plugintools.add_item(title='[COLOR gray]-=========================-[/COLOR]',folder=False, isPlayable=False) 
        for generos in data: 
...
def colorea(titulo):
    ...
    if  'Portugal' in titulo.lower() or 'PT' in titulo.lower() or 'EU -PT' in titulo or 'Portugal' in titulo.lower() or 'EU-PT' in titulo:               
        color='darkorange'                                             
    else:
...
def acemenu(params):
    ...
    plugintools.add_item(title='[COLOR gray]-=========================-[/COLOR]',folder=False, isPlayable=False) 
    plugintools.add_item(action="listaace", title="AceStream Portugal",thumbnail=thmb_ver_stb, fanart="",  url= "", folder= True )    
    plugintools.add_item(action="listaace2", title="AceStream World",thumbnail=thmb_ver_stb, fanart="",  url= "", folder= True )    
    ...
    plugintools.add_item(action="cautaace", title="AceStream Search",thumbnail=thmb_ver_stb, fanart="",  url= "", folder= True )    

def listaace(params): 
    plugintools.log("fenix.mac.listaace")
    thumbnail = params.get("thumbnail")    
...
def listaace2(params): 
    plugintools.log("fenix.mac.listaace2")
    thumbnail = params.get("thumbnail")    
...
def En_Directo(params): 
    plugintools.log("fenix.mac.directo")
    thumbnail = params.get("thumbnail")    
...
def ytfilme(params): 
    plugintools.log("fenix.mac.ytfilme")
    thumbnail = params.get("thumbnail")    
...
def yt_main_list(params):
    ...
    for i in range(len(aLista)):
        titu = aLista[i][0]
        id_canal = aLista[i][1]
        logo = translatePath(os.path.join(mislogos , aLista[i][2]))
        descrip = aLista[i][3]
