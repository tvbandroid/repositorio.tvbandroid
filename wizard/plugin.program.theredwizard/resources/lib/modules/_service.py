...
from .addonvar import setting, setting_set, addon_name, addon_icon, isBase64, headers, dialog, local_string, addon_id, gui_save_default, UPDATE_VERSION, CURRENT_BUILD, CURRENT_VERSION, BUILD_URL, OLD_BUILD, BUILD_NAME
...
class Startup:
    def check_updates(self):
           ...
           if UPDATE_VERSION is None:
               ...
               if UPDATE_VERSION > CURRENT_VERSION and setting('update_passed') != 'true' and CURRENT_BUILD in OLD_BUILD:
