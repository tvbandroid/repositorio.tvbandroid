...
OLD_BUILD       = ['The Red Wizard Full Build', 'The Red Wizard Family Build', 'The Red Wizard Live Build', 'The Red Wizard Live Family Build', 'Redflix Build', 'The Redflix TOTAL Build', 'The Red Wizard Ultra-Lite Build', 'The Red Wizard Ultra-Lite Family Build', 'The Red Wizard Ultra-Lite Gratis Build', 'The Red Wizard Ultra-Lite Gratis Family Build', 'The Red Wizard Touch! 18 Adult', 'The Red Wizard Touch!']
...
def get_version():
    ...
    for build in builds:
       if build.get('name') == 'Red Wizard Full' and CURRENT_BUILD == 'The Red Wizard Full Build':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
       elif build.get('name') == 'Red Wizard Family' and CURRENT_BUILD == 'The Red Wizard Family Build':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
       elif build.get('name') == 'Red Wizard Live' and CURRENT_BUILD == 'The Red Wizard Live Build':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
       elif build.get('name') == 'Red Wizard Live Family' and CURRENT_BUILD == 'The Red Wizard Live Family Build':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
       elif build.get('name') == 'Redflix' and CURRENT_BUILD == 'Redflix Build':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
       elif build.get('name') == 'Redflix TOTAL' and CURRENT_BUILD == 'The Redflix TOTAL Build':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
       elif build.get('name') == 'Ultra-Lite' and CURRENT_BUILD == 'The Red Wizard Ultra-Lite Build':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
       elif build.get('name') == 'Ultra-Lite Family' and CURRENT_BUILD == 'The Red Wizard Ultra-Lite Family Build':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
       elif build.get('name') == 'Ultra-Lite Gratis' and CURRENT_BUILD == 'The Red Wizard Ultra-Lite Gratis Build':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
       elif build.get('name') == 'Ultra-Lite Gratis Family' and CURRENT_BUILD == 'The Red Wizard Ultra-Lite Gratis Family Build':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
       elif build.get('name') == 'Touch! 18+' and CURRENT_BUILD == 'The Red Wizard Touch! 18 Adult':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
       elif build.get('name') == 'Touch!' and CURRENT_BUILD == 'The Red Wizard Touch!':
               name = str(build.get('name'))
               version = str(build.get('version'))
               url = (build.get('url', ''))
               break
...
BUILD_NAME, UPDATE_VERSION, BUILD_URL = get_version()
