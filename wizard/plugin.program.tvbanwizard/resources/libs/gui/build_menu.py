        ...
        if len(match) >= 1:
            if CONFIG.SEPARATE == 'true':
                ...
                if count22 > 0:
                    ...
                    directory.add_file('[B][COLOR orange]{0} BUILDS [COLOR azure]- [COLOR orange]PARCHES:[COLOR azure] TVBAN [COLOR cyan]MATNEXOM [COLOR magenta]PIERS[/COLOR][/B]'.format(state, count22), {'mode': 'togglesetting',
